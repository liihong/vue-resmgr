...
-- ------------------------------------------------------
 ...
 CREATE TABLE `RESOURCE_TABLE` 
   (	`TABLE_ID` VARCHAR(20)  NOT NULL COMMENT '表id,主键', 
	...
	`ALIAS_NAME` VARCHAR(255 ) COMMENT '别名名称',  
	...
	`ISVIEW` VARCHAR(1 ) COMMENT '是否是视图', 
	`ISADD` VARCHAR(1 ) COMMENT '是否可新增', 
	`ISEDIT` VARCHAR(1 ) COMMENT '是否可编辑', 
	`ISEDLETE` VARCHAR(1 ) COMMENT '是否可删除', 
